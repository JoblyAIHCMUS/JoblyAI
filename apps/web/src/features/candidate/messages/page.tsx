...
import { mapChatSummaryToConversation } from '@/features/employer/messages/utils';
...
export default function CandidateMessagesPage() {
  ...
  useEffect(() => {
    ...
    setSelectedConversation((prev) => {
      if (prev) return prev;
      const deeplinked = deeplinkRecruiterId
        ? conversations.find((c) => c.participantId === deeplinkRecruiterId)
        : undefined;
      return deeplinked ?? conversations[0];
    });
  }, [conversations, deeplinkRecruiterId]);
