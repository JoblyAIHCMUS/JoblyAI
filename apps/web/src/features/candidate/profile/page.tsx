...
const candidate = {
  ...
  portfolios: [
    { img: "https://placehold.co/203x152", name: "Clinically - clinic & health care website" },
    { img: "https://placehold.co/203x152", name: "Growthly - SaaS Analytics & Sales Website" },
    { img: "https://placehold.co/203x152", name: "Planna - Project Management App" },
    { img: "https://placehold.co/203x152", name: "Funiro - Landing Page for furniture shop" }
  ],
  contact: {
