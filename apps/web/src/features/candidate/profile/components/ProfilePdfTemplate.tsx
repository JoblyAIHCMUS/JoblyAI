...
export const ProfilePdfTemplate = React.forwardRef<
  HTMLDivElement,
  ...
  return (
    <div
      ...
      style={{
        minHeight: '1123px',
        fontFamily:
          '"Latin Modern Roman", "Computer Modern", "CMU Serif", "Times New Roman", Times, Georgia, serif',
        color: '#000000',
        fontSize: '10.5pt',
        lineHeight: '1.45',
      }}
    >
      {/* ── HEADER ── */}
      <div
        className="flex flex-col items-center text-center gap-1 mb-4 pb-1"
        data-pdf-block="true"
      >
        <h1
            ...
            <div className="flex flex-col gap-1">
              {bio
                ...
                .map((paragraph, pIdx) => (
                  <p
                    key={pIdx}
                    className="text-[10.5pt] text-slate-900 leading-relaxed m-0"
                    data-pdf-block="true"
                  >
                    {paragraph}
                  </p>
