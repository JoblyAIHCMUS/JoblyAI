...
import { SUPPORTED_CLIENTS } from './types';

const SETUP_COMMAND = 'npx jobly-mcp';
      ...
      <div className="flex flex-col gap-2">
        ...
        <ul className="flex flex-col gap-1.5">
          {SUPPORTED_CLIENTS.map((client) => (
            <li
              key={client.name}
              className="flex items-center justify-between rounded-md border border-[#d6ddeb] px-3 py-2"
            >
