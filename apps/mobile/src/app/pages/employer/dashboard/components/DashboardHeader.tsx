...
export const DashboardHeader = () => {
  return (
    <View className="px-6 pt-10 pb-6">
      <Text className="text-[30px] font-extrabold text-[#0F172A] mb-1">
        Good morning, Maria
      </Text>
      <Text className="text-[18px] text-[#475569] mb-2 leading-6">
      ...
      >
        <Text className="text-[18px] font-medium text-[#0F172A]">
          Jul 19 - Jul 25
        </Text>
